...
export type ArgsInput_1_2_3_4_5_6_7 = {
    after?: t.String;
    before?: t.String;
...
export type ArgsInput_1_2_3 = {
    after?: t.String;
    before?: t.String;
    first: t.NotSupportedYet;
    last: t.NotSupportedYet;
};
export type ArgsInput_1_2_3_4 = {
    after?: t.String;
    before?: t.String;
    first: t.NotSupportedYet;
    last: t.NotSupportedYet;
...
export type ArgsInput_1_2_3_4_5 = {
    after?: t.String;
    before?: t.String;
    first: t.NotSupportedYet;
    last: t.NotSupportedYet;
...
export type ArgsInput_1_2_3_4_5_6 = {
    after?: t.String;
    before?: t.String;
    first: t.NotSupportedYet;
    last: t.NotSupportedYet;
...
export class Profile {
    ...
    posts: Post[];
    starredPosts: (args?: {
        args?: ArgsInput_1_2_3;
    }) => Connection_1_2;
    followers: (args?: {
        args?: ArgsInput_1_2_3_4;
    }) => Connection_1_2_3;
    following: (args?: {
        args?: ArgsInput_1_2_3_4_5;
    }) => Connection_1_2_3_4;
    activity: (args?: {
        args?: ArgsInput_1_2_3_4_5_6;
    }) => Connection_1_2_3_4_5;
    views: t.NotSupportedYet;
    constructor() { this.__typename = ""; this.id = ""; this.bio = null; this.createdAt = ""; this.updatedAt = ""; this.language = null; this.posts = arrayProxy(Post); this.starredPosts = fnProxy(Connection_1_2); this.followers = fnProxy(Connection_1_2_3); this.following = fnProxy(Connection_1_2_3_4); this.activity = fnProxy(Connection_1_2_3_4_5); this.views = null; }
}
export class Post {
    __typename: t.String;
    id: t.String;
    ...
    profile: t.Nullable<Profile>;
    stars: (args?: {
        args?: ArgsInput_1_2_3_4_5_6_7;
    }) => Connection_1_2_3_4_5_6;
    views: t.NotSupportedYet;
    constructor() { this.__typename = ""; this.id = ""; this.slug = ""; this.title = ""; this.avatarURL = null; this.summary = null; this.content = null; this.profileId = ""; this.createdAt = ""; this.updatedAt = ""; this.privacy = null; this.language = null; this.profile = proxy(Profile); this.stars = fnProxy(Connection_1_2_3_4_5_6); this.views = null; }
}
export class Connection_1_2_3_4_5_6 {
    ...
    constructor() { this.__typename = ""; this.nodes = arrayProxy(Nodes); this.edges = arrayProxy(Edge); this.pageInfo = proxy(PageInfo); this.totalCount = null; }
}
export class Nodes {
    __typename: t.String;
    profile: Profile;
...
export class Connection_1_2 {
    ...
    pageInfo: PageInfo;
    totalCount: t.NotSupportedYet;
    constructor() { this.__typename = ""; this.nodes = arrayProxy(Nodes_1); this.edges = arrayProxy(Edge_1); this.pageInfo = proxy(PageInfo); this.totalCount = null; }
}
...
export class Connection_1_2_3 {
    ...
    pageInfo: PageInfo;
    totalCount: t.NotSupportedYet;
    constructor() { this.__typename = ""; this.nodes = arrayProxy(Nodes_1_2); this.edges = arrayProxy(Edge_1_2); this.pageInfo = proxy(PageInfo); this.totalCount = null; }
}
export class Nodes_1_2 {
    __typename: t.String;
    follower: Profile;
    createdAt: t.String;
    constructor() { this.__typename = ""; this.follower = proxy(Profile); this.createdAt = ""; }
}
...
export class Connection_1_2_3_4 {
    ...
    pageInfo: PageInfo;
    totalCount: t.NotSupportedYet;
    constructor() { this.__typename = ""; this.nodes = arrayProxy(Nodes_1_2_3); this.edges = arrayProxy(Edge_1_2_3); this.pageInfo = proxy(PageInfo); this.totalCount = null; }
}
export class Nodes_1_2_3 {
    __typename: t.String;
    followed: Profile;
    createdAt: t.String;
    constructor() { this.__typename = ""; this.followed = proxy(Profile); this.createdAt = ""; }
}
...
export class Connection_1_2_3_4_5 {
    ...
    pageInfo: PageInfo;
    totalCount: t.NotSupportedYet;
    constructor() { this.__typename = ""; this.nodes = arrayProxy(Nodes_1_2_3_4); this.edges = arrayProxy(Edge_1_2_3_4); this.pageInfo = proxy(PageInfo); this.totalCount = null; }
}
...
export class Connection_1 {
    ...
    pageInfo: PageInfo;
    totalCount: t.NotSupportedYet;
    constructor() { this.__typename = ""; this.nodes = arrayProxy(Post); this.edges = arrayProxy(Edge_1_2_3_4_5_6); this.pageInfo = proxy(PageInfo); this.totalCount = null; }
}
